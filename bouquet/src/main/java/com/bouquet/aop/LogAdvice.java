...
public class LogAdvice {
	...
	@Around("execution(* com.bouquet.controller..*Controller.*(..))"
			+ " or execution(* com.bouquet.service..*Impl.*(..))"
			+ " or execution(* com.bouquet.persistence..*Impl.*(..))")
