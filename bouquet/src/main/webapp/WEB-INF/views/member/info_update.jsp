	...
	<section>
		<div class="section">
			<div class="inner_section">
				...
				<form class="form" method="POST" action="${path}/member/update" id="form">
					<!-- 아이디 -->
					<div class=join_menu>
						<div class="join_minititle">
							<label for="id">아이디</label>
						</div>
						<input type="text" name="bid" id="id" class="input_box" maxlength="20" placeholder="아이디를 입력해주세요." readonly="readonly" value="${mDto.bid}">
					...
					<div class=join_menu>
						...
						<input type="text" name="bname" id="name" class="input_box" maxlength="4" placeholder="이름을 입력해주세요." value="${mDto.bname}">
						<span class="error_message">올바른 값을 입력해주세요.</span>
						<div class="explanation">
					...
					<div class=join_menu>
						...
						<input type="text" name="bphone" id="phone" class="input_box" maxlength="11" placeholder="전화번호를 입력해주세요." value="${mDto.bphone}">
						<span class="error_message">올바른 값을 입력해주세요.</span>
						<div class="explanation">
					...
					<div class=join_menu>
						...
						<div class=address_wrap>
							<input type="text" name="bzipcode" id="sample6_postcode" placeholder="우편번호" value="${mDto.bzipcode}">
							<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
							<input type="text" name="baddr1" id="sample6_address" placeholder="주소" value="${mDto.baddr1}">
							<input type="text" name="baddr2" id="sample6_detailAddress" placeholder="상세주소" value="${mDto.baddr2}">
